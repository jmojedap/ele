...
<?php $this->load->view('plan_lector/style_v') ?>
...
|
        ...
        <div class="contenidos">
            ...
            <div class="container" v-show="contenido == 'juegos_descargables'">
                <?php $this->load->view('plan_lector/panel/juegos_descargables_v') ?>
            </div>
        </div>
    </div>
    ...
    <?php $this->load->view('plan_lector/panel/lectura_modal_v') ?>
    <?php $this->load->view('plan_lector/panel/asignar_archivo_modal_v') ?>
</div>

<?php $this->load->view('plan_lector/panel/vue_v') ?>
