<form accept-charset="utf-8" method="POST" id="pregunta_form" @submit.prevent="send_form">        
    ...
    <fieldset v-bind:disabled="loading">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <select name="enunciado_id" v-model="fields.enunciado_id" class="form-control">
                    <option value="">[ NINGUNA ]</option>
                    <option v-for="optionEnunciado in arrEnunciados" v-bind:value="optionEnunciado.cod">
                        {{ optionEnunciado.cod }} &middot;
                        {{ optionEnunciado.name }}
                    </option>
                </select>
            </div>
        </div>
