...
class Plan_lector extends CI_Controller{

// Variables generales
//-----------------------------------------------------------------------------
public $views_folder = 'plan_lector/';
public $url_controller = URL_APP . 'plan_lector/';
...
//
    ...
    function chat_ele()
    {
        ...
        $filePath = PATH_CONTENT . 'chat_ele/preguntas_chat_ele.json';
